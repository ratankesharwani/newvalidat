...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'Service_Rule_Details', component: ServiceRuleDetailsComponent ,data :{disableSearch:true}},
      { path: 'Create_Service_Rule', component: ServiceConfigurationComponent ,data :{disableSearch:true}},
